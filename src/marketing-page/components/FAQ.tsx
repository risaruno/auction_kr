...
const items = [
  ...
  },
  {
    "title": "전문가는 믿을수 있나요?",
    "type": "전문가 서비스",
    "content": "체르토는 안전하고 신뢰할 수 있는 거래 환경을 제공하기 위해 노력하고 있습니다.\n전문가의 자격을 입증하는 증빙 자료를 검토하고, 공인중개사협회 또는 대한법무사협회를 통해 자격 상실여부등을 확인 후 서비스 승인절차를 진행합니다."
  },
  {
    "title": "전문가 서비스의 손해 배상",
    "type": "전문가 서비스",
    "content": "(주)체르토은 통신판매중개자로서 이용자와 전문가 간 자유로운 거래를 위한 시스템을 운영 및 관리, 제공할 뿐이므로 전문가를 대리하지 않습니다. 이용자와 전문가 사이에 성립된 거래와 관련된 손해배상은 이용자와 전문가가 합의 해결해야 합니다."
  },
  {
  ...
  },
  {
    ...
    "type": "기타",
    "content": "매수신청대리인의 업무 영역에 대한 법원의 해석이 상의하여 공인중개사로 구성된 체르토 대리입찰 서비스에서는 부동산 이외에 자동차, 중기 등은 접수가 불가합니다.\n\n자동차, 중기 등 부동산 이외의 물건에 대한 경매 대리입찰은 전문가 서비스내 법무사대리입찰을 이용해주세요."
  },
  {
    "title": "결제 영수증이 필요한 경우",
    "type": "기타",
    "content": "지출 증빙이 필요하신 경우, 주식회사 체르토 상호로 발행되는 현금영수증(계좌이체 또는 토스페이)또는 카드 전표를 전달드립니다.\n\n[내 신청 내역] [영수증 확인]을 통해 확인해주세요."
  }
]
