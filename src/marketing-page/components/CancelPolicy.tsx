  ...
  return (
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: '100%', md: '60%' } }}>
        ...
        >
          본 규정은 바토너(이하 "회사")가 제공하는 서비스 이용과 관련하여 발생하는 환불 및 취소에 대한 규정을 정한 것입니다.
        ...
        <Typography
          ...
          sx={{ color: 'text.secondary', mb: { xs: 2, sm: 4 } }}
        >
          바토너는 입찰 보안 및 서비스 품질을 위해 제한된 대리인으로 운영중입니다. 서비스 이용료에는 의뢰인의 사건 정보를 수집처리하고 필요한 서류를 생성, 대리인 관리, 지정 대리인 확정 후 다른 의뢰인의 접수를 포기하는 비용과 해당일 다른 스케쥴을 포기하는 비용을 포함하고 있습니다. 접수 취소 시 아래와 같이 환불 수수료가 발생하므로 접수 시 유의해 주세요.
        </Typography>
        <Typography
          variant="body1"
          sx={{ color: 'text.secondary', mb: { xs: 2, sm: 4 } }}
        ...
        <Typography
          ...
          sx={{ color: 'text.secondary', mb: { xs: 2, sm: 4 } }}
        >
          (주)케이디씨텍 바토너는 대리 입찰 중개시스템의 제공자로 대리 입찰 당사자가 아닙니다.
