...
const items = [
  {
    title: '전문가 서비스',
    content: '전문가 서비스는 쎄르토에서 제공하는 전문가와의 직접 상담 서비스입니다. 전문가와의 상담을 통해 보다 전문적인 조언과 지원을 받을 수 있습니다.',
    services: ['권리 분석', '임장', '예상낙찰가산정', '특수물건분석', '부동산 관리', '사건기록열람']
  },
  {
    title: '전문가 서비스 이용 방법',
    content: '전문가 서비스는 쎄르토 웹사이트에서 신청할 수 있습니다. 신청 후 전문가와의 상담 일정을 조율하여 진행됩니다.',
    services: ['권리 분석', '임장', '예상낙찰가산정', '특수물건분석', '부동산 관리', '사건기록열람']
  }
]
